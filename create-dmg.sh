...
echo "Creating python Electrum-ZEC.app and .dmg"
sudo hdiutil create -fs HFS+ -volname "Electrum ZEC" -srcfolder "dist/Electrum ZEC.app" dist/electrum-zec-$VERSION-macosx.dmg
